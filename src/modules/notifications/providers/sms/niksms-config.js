...
exports.niksmsEndpoints = niksmsEndpoints;
var niksmsSendSmsResult = {
    1: {
        number: 1,
        name: 'Successful',
    ...
    2: {
        number: 2,
        name: 'UnknownError',
        description: 'خطای نا مشخصی رخ داده است که پیش بینی نشده بوده و باید با پشتیبانی فنی تماس بگیرید. (احتمال رخ دادن این خطا نزدیک به صفر بوده ولی جهت اطمینان، در مستندات ارائه می شود)'
    },
    3: {
        number: 3,
    ...
    15: {
        number: 15,
        name: 'SiteUpdating',
        description: 'سایت در حال عملیات به روزرسانی می باشد لطفا دقایقی دیگیر مجددا اقدام به ارسال نمایید.'
    },
    16: {
        number: 16,
...
exports.niksmsSendSmsResult = niksmsSendSmsResult;
var niksmsCheckDeliveryResult = {
    0: {
        number: 0,
        name: 'NotFound',
        description: 'هنگامی که کاربر درخواست مشاهده نتیجه پیامی را دارد که قبلا برای ما ارسال نکرده و در دیتابیس وجود ندارد.'
    },
    1: {
        number: 1,
        name: 'DoNotSend',
    ...
    11: {
        ...
        description: 'به علت طولانی تر شدن مدت زمان انتظار ارسال از حداکثر میزان تاخیر مجاز تعیین شده توسط کاربر، ارسال متوقف و بازگشت خورده است.'
    },
    14: {
        number: 14,
        name: 'NotDeliveredFiltering',
        description: 'به علت استفاده از کلمه/کلمات غیر قابل قبول از سوی مخابرات، فیلتر و متوقف شده است.'
    },
    15: {
        number: 15,
        name: 'WaitingForRecheckInOperator',
        description: 'به دلیل قطع شدن اینترنت یا .. این بسته نامشخص باقی مانده و باید تک تک پیامک هایش با اپراتور بررسی شود که تکراری ارسال نشود'
    },
    16: {
        number: 16,
        name: 'OperatorFault',
        description: 'اپراتور انتخابی برای ارسال پیامک شما جوابی به سرورهای ما ارسال نمی کند، احتمالا دچار نقص در سیستم ارسال خود شده است، با برطرف شدن این مشکل ارسال ها به روال عادی خود بر خواهند گشت.'
    },
    17: {
        number: 17,
    ...
    18: {
        ...
        description: 'در قسمت کنترل مجدد اپراتور مشخص شد که ارسال شده ولی وضعیتش هنوز به روزرسانی نشده.'
    },
    19: {
        number: 19,
...
exports.niksmsCheckDeliveryResult = niksmsCheckDeliveryResult;
