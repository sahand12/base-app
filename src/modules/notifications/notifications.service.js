...
var TEST_ACCOUNT = 'nahang.me@gmail.com';
// @Injectable()
var NotificationsService = /** @class */ (function () {
    function NotificationsService() {
        this.initialized = false;
    }
    NotificationsService.prototype.sendEmail = function (options) {
    ...
    NotificationsService.prototype.sendSms = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.init()];
    ...
    NotificationsService.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(this.initialized === false)) return [3 /*break*/, 2];
                        _a = this;
                        return [4 /*yield*/, nodemailer.createTestAccount()];
                    case 1:
                        _a.testAccount = _b.sent();
